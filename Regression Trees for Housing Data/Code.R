...
setwd("C:/Users/Mansi/Documents/Assignments/Analytics Edge/Analytics edge (GitHub)/Unit4_recitation")
...
# Longitude anda latitude of the centr of the census tract
...
# cp values (complexity parameter)
cp.grid = expand.grid( .cp = (0:10)*0.001)
# 0 to 0.01 with 0.001 as common difference
